...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/scraping/start', [BottleController::class, 'startScraping'])->name('scraping.start');
    Route::post('/scraping/stop', [BottleController::class, 'stopScraping'])->name('scraping.stop');
