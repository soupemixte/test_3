...
>>>>>>> bf533333394fcbb1990e323b7135ec679c544187
    ...
    private function scrapeBouteilleDetails($url, $client) {
        ...
        return [
            'saq_code' => $this->extractData($crawler, 'Code SAQ'),
            'country' => $this->extractData($crawler, 'Pays'),
            'region' => $this->extractData($crawler, 'Région'),
            'designation_of_origin' => $this->extractData($crawler, "Appellation d'origine"),
            'classification' => $this->extractData($crawler, 'Classification'),
            'grape_variety' => $this->extractData($crawler, 'Cépage'),
            'degree_alcohol' => $this->extractData($crawler, "Degré d'alcool"),
            'sugar_content' => $this->extractData($crawler, 'Taux de sucre'),
            ...
            'promoting_agent' => $this->extractData($crawler, 'Agent promotionnel'),
        ];
    }
